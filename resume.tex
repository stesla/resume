...
\begin{itemize}
  ...
  \begin{itemize}
    \responsibility{Work with Sojern, Inc.}
    \responsibility{Use Ruby on Rails to develop both internal and external
      applications.}
    \responsibility{Manipulate data in XML feeds and MySQL databases.}
    \responsibility{Design and implement a custom reporting tool.}
  \end{itemize}
