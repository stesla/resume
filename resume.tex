...
5844 Corby Street &  samuel@thoughtlocker.net\\
Omaha, NE 68104
\end{tabular*}
\\
...
\item
  ...
  \begin{itemize}
    \resitem{Design and develop software in C\# and Delphi.}
    \resitem{Implement agile practices such as pair programming and test-first design.}
    \resitem{Migrated version control from Microsoft Visual Source Safe to Subversion.}
    \resitem{Implement automated, continuous build using Ant and Rake.}
    \resitem{Administer department Linux and Windows servers housing Subversion, Apache,
      Postfix, and Samba.}
  \end{itemize}
...
\item
  ...
  \begin{itemize}
    \resitem{Administer various end-user services on Linux such as: Apache,
      Subversion, and PostgreSQL.}
    \resitem{Implement virtual hosting for a large number of domains.}
  \end{itemize}
