...
\textbf{\Large Samuel Tesla}  & 402-980-0578\\
7110 Jones Cir \#11 &  stesla@pobox.com\\
Omaha, NE 68106 & http://www.alieniloquent.com\
\end{tabular*}
\\
...
\begin{itemize}
\item
        \ressubheading{AIMS Community College}{Greeley, CO}{AA,
...
%    \resitem{Develop technical training material.}
  \end{itemize}
...
\begin{description}
\item[Languages:]
C/C++, Java, Perl, Ruby, PHP, \LaTeX, HTML, CSS, JavaScript, XML, RSS
\item[Operating Systems:]
Linux, Solaris, FreeBSD, Windows 95/98/NT/2000/XP
\item[Miscellaneous:]
